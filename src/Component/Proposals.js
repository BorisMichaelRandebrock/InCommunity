            ...
            Data.map((e, id) => {
              ...
              <div class="p-4">
                <div class="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                  <h2 class="tracking-widest text-xl title-font font-medium text-gray-400 mb-1">Proposal Id-: {id}</h2>
                  <h1 class="title-font sm:text-2xl text-xl font-medium text-gray-900 mb-3">{e.name}</h1>
                  ...
                  <button onClick={() => Vote(id)}class="flex mx-auto mt-10 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded">Vote Now</button>
                </div>
                </div>
              )
            })
